...
namespace WebsiteNhaHang.Controllers
{
    public class DatBanController : Controller
    {
        ...
        public ActionResult ThanhToan(int soNguoi, DateTime ngayAn)
        {
            ...
            mail.From = new MailAddress("taikhoangmailcuaban");
            ...
            smtp.Credentials = new System.Net.NetworkCredential("taikhoangmailcuaban", "Matkhaugmailcuaban");// tài khoản Gmail người gửi
            smtp.EnableSsl = true;
            smtp.Send(mail);
            Session.Remove("GioHang");
            return Json(new
